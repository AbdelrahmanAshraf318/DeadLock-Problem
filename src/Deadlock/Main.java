	...
	public static void main(String[] args) {
		...
		System.out.println("Enter the number of Processes you want to be in the system: ");
			...
			do {
				...
				keep = input.next();
				input.nextLine();
				if(keep.equals("exit") || keep.equals("Exit"))
				{
				...
				if(keep.equals("RL"))
				{
					...
					for(int counter = 0 ; counter<numOfResources ; counter++)
					{
						...
						System.out.print("Enter request number-" + counter + " ");
						requestResource = input.nextInt();
						release.add(requestResource);
						System.out.println();
					}
					banker.releaseResource(release, numOfProcess); 
					
				}
				else
				{
					System.out.println("Enter from the following query");
					keep = "RQ";
				}
		  }while(keep.equals("RQ")  || keep.equals("RL"));
